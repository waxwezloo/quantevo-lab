    ...
    <div className="flex flex-col gap-3">
      ...
      >
        <div className="p-3.5 flex flex-col gap-3">
          ...
          <p className="text-[10px] leading-relaxed text-dim">
            Мгновенный прогон без эволюции. Импорт понимает JSON веб-лаборатории и best_params.json из
            Python-скрипта; экспорт особи — кнопка JSON в панели «Метрики бэктеста».
          </p>
        </div>
      </Panel>
